...
|-----------|---------------|
| ![Main Page](assets/MainPage.png) | ![Expanded](assets/Expanded.png) |
...
|--------------|----------------------|-------------------|
| ![Video Player](assets/VideoPlayer.png) | ![Custom Subtitles](assets/CustomSubtitles.png) | ![Picture in Picture](assets/PictureInPicture.png) |
